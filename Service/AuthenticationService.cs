...
internal sealed class AuthenticationService : IAuthenticationService
{
	...
	public async Task<TokenDto> CreateToken(bool populateExp)
	{
		...
		var tokenmOptions = GenerateTokenOptions(signingCredentials, claims);
		...
		var accessToken = new JwtSecurityTokenHandler().WriteToken(tokenmOptions);
	...
	public async Task<bool> ValidateUser(UserForAuthenticationDto userForAuth)
	{
		...
		if (!result)
			_logger.LogWarn($"{nameof(ValidateUser)}: Authentication failed. Wrond user name or password.");
